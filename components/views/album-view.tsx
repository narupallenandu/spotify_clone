...
import { albums, formatDuration } from "@/lib/music-data"
...
export function AlbumView({ albumId }: AlbumViewProps) {
  ...
  const isAlbumPlaying =
    player.isPlaying &&
    player.currentTrack &&
    album.tracks.some((t) => t.id === player.currentTrack?.id)
  ...
  return (
    <div className="flex flex-col">
          ...
          return (
            <button
              ...
              onClick={() =>
                isCurrentTrack
                  ? actions.togglePlay()
                  : actions.playTrack(track, album.tracks, idx)
              }
              className={cn(
      ...
      {/* Footer info */}
      <div className="px-9 py-8 text-xs text-muted-foreground">
